...
(def templates (html-templates/monitor-client-templates))
...
(defn render-page [renderer [_ path] transmitter]
  (let [;; The renderer that we are using here helps us map changes to
        ...
        ;; Get the dynamic template named :monitor-client-page
        ...
        html (templates/add-template renderer path (:monitor-client-page templates))]
